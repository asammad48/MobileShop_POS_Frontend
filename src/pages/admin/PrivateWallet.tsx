...
return ( <div className="space-y-8"> <div className="flex justify-between items-center"> <h1 className="text-3xl font-semibold">Private Wallet</h1> <div className="flex gap-2">
<Button onClick={() => setModalOpen(true)}> <Plus className="w-4 h-4 mr-1" /> Add Transaction </Button>
<Button
variant="outline"
onClick={() =>
toast({ title: "Printed!", description: "Wallet summary sent to printer." })
}
> <Printer className="w-4 h-4 mr-1" /> Print </Button> </div> </div>
